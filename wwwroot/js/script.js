...
const showPizzaItems =(e)=>{
    const ItemID = e.target.id
    console.log(ItemID)
    document.getElementById(ItemID).style.background = "red";
    console.log("button was click", e.target.innerText)
    
}



// show and hide items from a db
...
const showItem =(e)=>{  
    ...
    function getCookie() {
      ...
      var getItem = getCookie("savedItem");
      console.log("getting item from cookies",getItem);
      
    const ItemSelected = e.target.id
    console.log("Current Item:",ItemSelected);

    document.cookie = "savedItem" + "=" + ItemSelected +";";
    document.getElementById(getItem).style.height ="30px"
    document.getElementById(ItemSelected).style.display ="grid"
    document.getElementById(ItemSelected).style.height = "auto";
